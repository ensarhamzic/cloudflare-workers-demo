...
var cron_default = {
  ...
  async scheduled(_controller, env2) {
    console.log("CRON triggered");
    const res = await env2.API.fetch("https://internal/run", { method: "POST" });
    if (!res.ok) {
...
var prefix = "\x1B[34m[cron-worker]\x1B[39m";
...
// .wrangler/tmp/bundle-mhrKKD/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-mhrKKD/middleware-loader.entry.ts
